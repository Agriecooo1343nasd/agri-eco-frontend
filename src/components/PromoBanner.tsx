        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative px-8 md:px-16 py-12 md:py-20">
            <div className="max-w-lg">
              <span className="inline-flex items-center gap-1.5 bg-secondary text-secondary-foreground text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full">
                <Tag className="h-3 w-3" />
                {t(translations.sections.promo.label)}
              </span>
              <h2 className="text-2xl md:text-4xl font-bold text-card font-heading mt-4 leading-tight">
                {t(translations.sections.promo.heading)}
              </h2>
              <p className="text-card/80 mt-4 text-sm md:text-base">
                {t(translations.sections.promo.subheading)}
              </p>
              <Link
                href="/deals"
              ...
              >
                {t(translations.sections.promo.cta)}
