          ...
          {isLoadingProducts
            ...
            : products.map((product) => {
                ...
                const mappedProduct = {
                  ...
                  ownerName: product.source === "artisan" ? product.artisan?.name : undefined,
                  ownerHref: product.source === "artisan" && product.artisan?.id ? `/community/artisan/${product.artisan.id}` : undefined,
                };
